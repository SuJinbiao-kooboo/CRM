  ...
  <div class="app-container">
    ...
    <div class="list-layout">
      <div class="table-container">
        <el-table v-loading="loading" :data="stockList" height="100%">
    ...
    <el-dialog title="库存导入" :visible.sync="importVisible" width="600px">
      <el-form :model="importForm" label-width="120px">
        ...
        <el-form-item label="SHEET_NAME列">
          <el-select v-model="importForm.sheetNameCol" placeholder="请选择">
            <el-option v-for="item in columnOptions" :key="item" :label="item" :value="item" />
          </el-select>
        </el-form-item>
  ...
  methods: {
    ...
    handleExport() {
      exportStock(this.queryParams).then(response => {
        ...
        link.href = url
        link.setAttribute('download', '库存数据.xlsx')
